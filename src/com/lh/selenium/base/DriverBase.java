...
public class DriverBase {
	...
	public DriverBase(String driverName) {
		...
		SelectDriver sDriver = new SelectDriver();
		this.driver = sDriver.DriverName(driverName);
	}
	...
	public void takeScreenShot() {
		...
		GetTakesScreenshot(path);
	}

	/**
	 * 截图方法
	 */
	public void GetTakesScreenshot(String path) {
		String currnetPath = System.getProperty("user.dir");
		File scrFile = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		try {
			FileUtils.copyFile(scrFile, new File(currnetPath + "\\erroTakeshot" + "\\" + path));
		} catch (IOException e) {
